...
<body
    ...
    <div class="container m-10">
        <form method="POST" action="/notes/<?php echo e($note[0]['note_id']); ?>">
            ...
            <div class="form-outline mb-2">
                ...
                <input type="text" id="title" name="title" class="form-control" value="<?php echo e($note[0]['title']); ?>" />
            </div>

            <!-- Detail input -->
            <div class="form-outline mb-2">
                <label class="form-label text-white" style="font-weight: bold;" for="detail">Detail</label>
                <textarea class="form-control" name="detail" id="detail" rows="4"> <?php echo e($note[0]['detail']); ?></textarea>
            </div>
...
<?php /**PATH C:\Users\nabil\Videos\MOODO-WEB-BISMILLAH\MOODO-WEB-BISMILLAH\resources\views/note/edit.blade.php ENDPATH**/ ?>